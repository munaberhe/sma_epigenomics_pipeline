.libPaths("~/R/library")
# parameter_benchmark_neighbourhood_mingap_archie.R
# Neighbourhood minGap benchmark — Archie scramble null model
# minGap varied at 100, 200, 300, 500, 1000, 2000bp on whole chr1
# Identical structure to label-swap version — only scrambling method differs
...
message("\n=== NEIGHBOURHOOD minGap RESULTS (Archie scramble) ===")
...
message("\nDone. Saved to: ", OUT_DIR,
        "/parameter_benchmark_neighbourhood_mingap_archie.csv")
