...
# ============================================================
# 4. CpG island overlap — simplified, no setdiff
# ============================================================
...
# Simple shore definition — just flank, no setdiff
shores <- c(flank(cpgi, 2000, start=TRUE),
...
results <- do.call(rbind, lapply(seq_along(CONTRASTS), function(i) {
  ...
  n_shore  <- length(subsetByOverlaps(d, shores)) - n_island
