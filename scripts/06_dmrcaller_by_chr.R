...
# chromosome. Genome-wide attempts (SLURM jobs 10504170, 10591016) ran for
# 18-27 hours without completing the iterative merge step (>98GB RAM used).
# Results are combined afterwards by dmrcaller_combine_chr.R.
#
# Usage: Rscript scripts/06_dmrcaller_by_chr.R <contrast> <chr>
# Example: Rscript scripts/06_dmrcaller_by_chr.R ASO_VPA_vs_Scramble_CTRL chr13
#
