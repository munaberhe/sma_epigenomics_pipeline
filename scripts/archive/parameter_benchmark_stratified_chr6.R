...
chr_region <- GRanges("chr6", IRanges(1, REGION_END))

make_tiles <- function(binsize) {
  GRanges("chr6", IRanges(
...
write.csv(summary_df,
          file.path(OUT_DIR, "parameter_benchmark_stratified_scramble_chr6.csv"),
          row.names = FALSE)
...
message("\nDone. Saved to: ", OUT_DIR,
        "/parameter_benchmark_stratified_scramble_chr6.csv")
