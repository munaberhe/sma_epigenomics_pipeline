...
# MSigDB enrichment for all 5 contrasts and ASO-specific DMRs.
# Tests neural, chromatin, splicing gene sets from GO:BP and Reactome.
# Run separately from 07_dmr_annotate.R to keep GO and MSigDB results distinct.
