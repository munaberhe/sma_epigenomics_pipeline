...
#
# Run this after all per-chromosome jobs (06_dmrcaller_by_chr.R) complete.
...
#
# Usage: Rscript scripts/06b_dmrcaller_combine_chr.R
...
CONTRASTS <- c(
  ...
  "ASO_CTRL_vs_Scramble_CTRL",       # ASO alone — isolates nusinersen effect
  "ASO_VPA_vs_ASO_CTRL",             # VPA effect on ASO background
  "ASO_VPA_vs_Scramble_VPA"          # ASO effect on VPA background
)
